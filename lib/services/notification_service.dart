...
class NotificationService extends GetxController {
  ...
  Future postNotification(
    ...
    Map<String, String> headers = {
      ...
      "Authorization":
          "key=AAAAEngWI_c:APA91bHzY1Q_EyTErmwKIzZL45rFidp_3s2Qk0TkCnrzBrtoVYoyO_5byedPZVIqnattnLVjDU9lzc7lZVmxPlMwJCdjpx_9E0IN5ffqV6XlfjIYKnl7ZeMS4V2h380wny4OaewBgpRa"
    };
    var json = jsonEncode({
      "notification": {
        "body": body,
